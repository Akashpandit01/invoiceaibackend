...
# ❌ COMMENTED FOR RENDER (requires system dependencies not available)
# import pytesseract
...
def extract_text(path, filename):
    ...
    try:
        # ❌ ORIGINAL OCR LOGIC (DISABLED FOR RENDER)
        ...
        # ✅ ADDED SAFE FALLBACK (keeps app working)
...
async def upload(file: UploadFile = File(...), authorization: str = Header(None)):
    ...
    supabase.table("invoices").insert({
        **parsed,
        ...
        # ❌ LOCAL URL (NOT WORKING IN DEPLOY)
